...
public interface IAdvisoryContractService
{
    ...
    Task<PagedResult<AdvisoryContractViewModel>> GetAdvisoryContractsByProfessorIdAsync(Guid professorId, int status,int pageNumber, int pageSize, SortQuery? sortQuery = null, bool includeDeleted = false, string? searchTerm = null);


    Task<PagedResult<AdvisoryContractViewModel>> GetAdvisoryContractsByStudentIdAsync(Guid studentId,int status, int pageNumber, int pageSize, SortQuery? sortQuery = null, bool includeDeleted = false, string? searchTerm = null);
